...
<head>
    ...
    <link rel="shortcut icon" href="{{ URL::to('assets/img/favicon.svg') }}">
    ...
    <link rel="stylesheet" href="{{ URL::to('assets/css/upload.css') }}">
    <script src="{{ URL::to('assets/js/upload.js') }}"></script>
</head>
        ...
        <div class="header">
            <div class="header-left">
                ...
                <a href="{{ route('home') }}" class="logo logo-small">
                    <img src="{{ URL::to('assets/img/logo-small.svg') }}" alt="Logo" width="30" height="30">
                </a>
            </div>
                        ...
                        <div class="noti-content">
                            <div>
                                <a class="dropdown-item" href="javascript:;"><i
                                        class="flag flag-us me-2"></i>English</a>
                                <a class="dropdown-item" href="javascript:;"><i class="flag flag-fr me-2"></i>French</a>
                                <a class="dropdown-item" href="javascript:;"><i class="flag flag-sa me-2"></i>Arabic</a>
                            </div>
                        </div>
                    </div>
                </li>
