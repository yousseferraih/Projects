                        ...
                        <div class="profile-head">
                            ...
                            <div class="profile-info">
                                <div class="profile-photo">
                                    <img src="{{ URL::to('assets/images/' . Session::get('avatar')) }}"
                                        ...
                                        <div id="about-me" class="tab-pane fade">
                                            <div class="profile-about-me">
                                                <div class="pt-4 border-bottom-1 pb-3">
                                                    ...
                                                    <p class="mb-2">Advance Code, There are websites such as HTML, CSS,
                                                        Javascript, PHP, Framework Laravel,<br>
                                            ...
                                            <div class="profile-lang  mb-5">
                                                ...
                                                <a href="javascript:void(0);" class="text-muted pe-3 f-s-16"><i
                                                        class="flag-icon flag-icon-sa"></i> Arabic</a>
                                            </div>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control" name="user_id"
                                                                    readonly value="{{ Session::get('user_id') }}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    name="join_date" readonly
                                                                    value="{{ Session::get('join_date') }}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                            ...
                                                            <div class="mb-3 col-md-6">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                    ...
                                                                    value="{{ Session::get('role_name') }}">
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="mb-3 col-md-6">
                                                                <label class="form-label">Status</label>
                                                                <input type="tel" class="form-control" name="status"
                                                                    readonly value="{{ Session::get('status') }}">
                                                            </div>
                                                            <div class="mb-3 col-md-6">
