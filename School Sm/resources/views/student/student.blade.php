                            ...
                            <div class="page-header">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-auto text-end float-end ms-auto download-grp">
                                        ...
                                        <a href="#" class="btn btn-outline-primary me-2" onclick="importData()">
                                            <i class="fas fa-file-import"></i> Import Students</a>
...
@section('script')
    ...
    <script>
        ...
        importButton.onclick = function() {
            useCsvPlugin({
                importerKey: "5088541a-a2fd-40df-ad7d-9210824c2e28",
                user: {
                    userId: "12345"
                },
                metadata: {
